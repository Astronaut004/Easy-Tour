    ...
    <div class="d-flex align-items-center ml-auto">
      ...
      <div class="dropdown text-end ms-3">
        <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="../<?php echo $image ?>" alt="Profile" width="32" height="32" class="rounded-circle">
        </a>
        <ul class="dropdown-menu text-small mybg">
          <li><a class="dropdown-item" href="./userSetting.php">Settings</a></li>
          <li><a class="dropdown-item" href="./Userprofile.php?name=<?php echo $name ?>">Profile</a></li>
          <li>
